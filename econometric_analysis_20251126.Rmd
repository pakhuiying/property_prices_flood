...
flood_residential_fp <- file.path(getwd(),"Exported_Data",
                                  "floodPrivateResidential_20260117_buffer200_networkDepth2_adaptationBuildingName.csv")
...
- TODO: Add interaction: Hazard x Vulnerability
...
### 5.4A: How does adaptation moderate the effect of flood on prices by centrality (for private non-landed properties)
...
etable(model_5h)
```
### 5.4B: How does adaptation moderate the effect of flood on prices by centrality (for landed properties)
